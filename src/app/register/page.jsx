...
const RegisterPage = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col text-primaryText items-center justify-center min-h-screen bg-gray-100 px-4 py-8 mt-16">
        <div className="bg-white p-8 rounded-xl  w-full max-w-md shadow-lg">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              <label
                htmlFor="namaLengkap"
                className="block text-primaryText mb-1"
              >
                Nama Lengkap
              </label>
              <input
                ...
                className="w-full p-3 border border-gray-300 text-secondaryText rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full p-3 border border-gray-300 rounded-lg text-secondaryText focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none text-secondaryText focus:ring-2 focus:ring-blue-500 pr-10"
              />
              <button
                type="button"
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full p-3 border border-gray-300 text-secondaryText rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10"
              />
              <button
                type="button"
                className="absolute inset-y-0 right-3 flex items-center"
              ...
              >
                {showConfirmPassword ? (
                  <FaEyeSlash className="text-primaryText mt-7" />
                ) : (
                  <FaEye className="text-primaryText mt-7" />
                )}
              </button>
          ...
          <div className="flex justify-center gap-4 mt-4">
            <div className="flex items-center space-x-2 p-5 border-2 rounded-full">
